      ...
      <View style={{ backgroundColor: '#000', height: '4%', }}></View>
        ...
        <ScrollView style={{ flex: 1 }}>
          <View style={styles.DetailTextView}>
            <AntDesign style={styles.IconStyle} name='idcard' size={30} />
            <Text style={styles.TextStyle}>923219646084</Text>
          </View>
          <View style={styles.DetailTextView}>
            <MaterialCommunityIcons style={styles.IconStyle} name='onepassword' size={30} />
            <Text style={styles.TextStyle}>Password</Text>
          </View>
          <View style={styles.DetailTextView}>
            <Entypo style={styles.IconStyle} name='phone' size={30} />
            <Text style={styles.TextStyle}>Phone No</Text>
          </View>
          <View style={styles.DetailTextView}>
            <AntDesign style={styles.IconStyle} name='mail' size={30} />
            <Text style={styles.TextStyle}>Email</Text>
          </View>
          <View style={styles.DetailTextView}>
            <MaterialCommunityIcons style={styles.IconStyle} name='city' size={30} />
...
Profile.navigationOptions = ({ navigation }) => {
  return {
    ...
    drawerIcon: ({ tintColor }) => (
      <AntDesign style={{ color: tintColor, }} name="profile" size={25} />
    )
  };
};
