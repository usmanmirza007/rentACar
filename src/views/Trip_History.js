...
import { FontAwesome,FontAwesome5, Entypo,AntDesign, Feather,Fontisto ,MaterialIcons,MaterialCommunityIcons} from '@expo/vector-icons';
      ...
      <View style={{ backgroundColor: '#000', height: '4%', }}></View>
        ...
        <TouchableOpacity style={styles.TouchableStyle} onPress={() => this.setState({ showModal: true })}>
          <View style={{ flexDirection: 'row' }}>
            <FontAwesome5 style={{ color: 'orange', margin: 15, }} name='shuttle-van' size={30} />
...
Trip_History.navigationOptions = ({ navigation }) => {
  return {
    ...
    drawerIcon: ({ tintColor }) => (
      <MaterialIcons style={{ color: tintColor, }} name="details" size={25} />
    )
  };
};
